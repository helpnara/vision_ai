...
**크기가 4천 배 다르다.** 분류는 이미지 한 장이 숫자 14개(56바이트)지만, 이상탐지는
31×31 격자마다 14개라 장당 53KB다. 4,584장이면 0.25GB — `feature_cache`가 쓰는
"전부 읽어 사전에 담고 압축해 통째로 다시 쓰기"를 그대로 하면 저장할 때마다 0.25GB를
...
"""저장 형식. 실측에서 이상 점수 상대 오차 4.2e-4, AUROC는 여섯 자리까지 동일했다."""
